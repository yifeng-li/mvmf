...
class ssmcnmf:
    ...
    def save_mf_result(self,dir_save="./",prefix="SSMCNMF"):
        """
    ...
    def save_feat(self,dir_save="./",prefix="SSMCNMF",rank_method="Wilcoxon-rank-sum-test",neglog10pval_threshold=10,if_each_pattern_per_file=False):
        """
    ...
    def plot_heatmap(self,dir_save="./",prefix="SSMCNMF",pattern="All",rank_method="mean_basis_value",unique_class_names=None, width=10, height=10, fontsize=6, fmt="png", dpi=600, colormap="hot", clrs=None, rng=numpy.random.RandomState(1000)):
        """
    ...
    def plot_F_mean(self,dir_save="./",prefix="SSMCNMF",normalize=False,rank_method="mean_basis_value",unique_class_names=None, width=6, height=6, fontsize=6, fmt="png", dpi=600, colormap="hot", clrs=None, rng=numpy.random.RandomState(1000)):
        """
    ...
    def learn_H_given_X_test_and_E_W(self,X_test,a_H_test=0.1,b_H_test=1e-10,feature_selection=True,max_iter=200,compute_variational_lower_bound=True,variational_lower_bound_min_rate=1e-4,if_plot_lower_bound=True,dir_save="./",prefix="SSMCNMF",verb=True,rng=numpy.random.RandomState(1000)):
        """
