...
class mvnmf_model_selection:
	...
	self.times_fact_fs=[] # factorization and feature selection time
        ...
        for a_0,b_0,a_large,b_large in all_combinations:
            ...
            # run the model
            model_fs=mvnmf.mvnmf(self.X,self.y,self.features)
    ...
    def plot_kld_acc(self,dir_save="./",prefix="mvnmf_model_selection",if_log2kld=False,figwidth=5,figheight=3):
    ...
    def save_result(self,dir_save="./",prefix="mvnmf_model_selection"):
