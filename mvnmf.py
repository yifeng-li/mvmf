...
class mvnmf:
    ...
    def plot_heatmap(self,dir_save="./", prefix="MVNMF", pattern="All", rank_method="mean_feature_value",unique_class_names=None, width=10, height=10, fontsize=6, fmt="png", dpi=600, colormap="hot", clrs=None, rng=numpy.random.RandomState(1000)):
        """
    ...
    def classify(self,feature_selection=True,method="coef_sum",method_param={"feature_extraction":False,"learning_rate":0.1, "alpha":0.01, "lambda_reg":0.00001, "alpha_reg":0.5, "n_hidden":None, "n_epochs":1000, "batch_size":200, "activation_func":"relu"},rng=numpy.random.RandomState(1000)):
        ...
        if method=="coef_sum":
            ...
            # split data
            train_subset_x,train_subset_y,_,valid_subset_x,valid_subset_y,_,test_subset_x,test_subset_y,_=cl.partition_train_valid_test2(train_set_x, train_set_y, others=None, ratio=(4,1,0), rng=rng)
